...
@section('content')
<x-page-header title="Import Data Guru" subtitle="Upload file Excel (.xlsx) untuk menambah / memperbarui guru massal">
    <x-slot:action>
...
<div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="card card-pad space-y-3 text-sm">
        ...
        <code class="block text-[10px] bg-slate-50 p-2 rounded border border-slate-200 break-all">
            nip | nama_ptk | email | nomor_hp | jenis_kelamin | tempat_lahir | tanggal_lahir | alamat | jabatan | status_kepegawaian | password | is_aktif
        </code>
        <ul class="text-xs text-ink-600 list-disc pl-5 space-y-1">
            <li>nip dan nama_ptk wajib diisi</li>
